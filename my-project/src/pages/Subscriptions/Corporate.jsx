    ...
    <main className="pt-24 bg-white text-gray-900">
      ...
      <section className="bg-gradient-to-r from-blue-600 to-indigo-700 text-white py-20 px-6 text-center">
        ...
        <p className="max-w-2xl mx-auto text-lg sm:text-xl mb-8">
          Tailored, high‑capacity internet and network services designed for large organizations.
        </p>
        <button className="bg-white text-indigo-700 font-semibold px-8 py-3 rounded-md shadow hover:bg-gray-100 transition">
          Get a Quote
        </button>
      </section>
      ...
      <section className="py-16 px-4 max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="p-8 border rounded-lg shadow hover:shadow-lg transition">
            ...
            <h3 className="text-xl font-semibold mb-2 text-center">Dedicated Bandwidth</h3>
          ...
          <div className="p-8 border rounded-lg shadow hover:shadow-lg transition">
            ...
            <h3 className="text-xl font-semibold mb-2 text-center">Custom SLAs</h3>
            <p className="text-gray-600 text-center">
              Tailored service level agreements to meet your uptime and support needs.
            </p>
          </div>
          <div className="p-8 border rounded-lg shadow hover:shadow-lg transition">
            <FaLifeRing className="text-indigo-600 w-10 h-10 mb-4 mx-auto" />
            <h3 className="text-xl font-semibold mb-2 text-center">24/7 Priority Support</h3>
            <p className="text-gray-600 text-center">
              Fast‑track issue resolution with our dedicated enterprise support team.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 px-4 max-w-4xl mx-auto text-center">
        <h2 className="text-3xl sm:text-4xl font-bold mb-12">What Enterprise Clients Say</h2>
        <div className="space-y-8">
          {[
            ...
            <blockquote key={i} className="italic text-gray-700">
              “{t.quote}”
              <cite className="block mt-4 font-semibold">{t.author}</cite>
            </blockquote>
          ))}
        </div>
      </section>
      ...
      <section className="text-center py-16 px-4">
        ...
        <button className="bg-indigo-600 text-white font-semibold px-8 py-3 rounded-md shadow hover:bg-indigo-700 transition">
